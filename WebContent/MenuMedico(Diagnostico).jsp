    ...
    <div class="cd-content-wrapper">
      <div class="text-component text-center">
      	<div class="card">
      		...
      		<br>
      		<br>
      		<h5>Insira o código da consulta que deseja diagnosticar:</h5>
      		<br>
      		<form action="MenuMedico(RealizarDiagnostico).jsp">
      			<p>Código da consulta: <input type="text" name="cod" required/></p>
      			<p><input class="btn btn-second" type="submit" value="Buscar" style="width:100px"/><p>
      		</form>
    	</div>
      </div>
    </div> <!-- .content-wrapper -->
