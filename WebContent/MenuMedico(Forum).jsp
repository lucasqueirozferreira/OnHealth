      ...
      <h1>Forum</h1>
      		...
      		<% for(ForumJB c: forum){
    	    	if(c.getResposta() == null){
    	  			out.print("<br>");
    	  			out.println("<form action='dire_Forum'>");
    	  			out.println("<input type='hidden'" + "name='cod'" + "value='" + c.getId() + "'" + "</>");
    		  		out.println("<div class='leftcolumn'>");
    	  			out.println("<p>" + "Título: " + c.getTitulo() + "</p>");
    	  			out.println("<div class='rightcolumn'>");
    	  			out.println("<p><input class='btn btn-second' type='submit' value='Responder'/></p>");
    	  			out.println("</div>");
      		...
      		if(forum == null){
	  			out.println("<p>" + "Sem perguntas no momento" + "</p>");
      		}
     	 	%>
    </div> <!-- .content-wrapper -->
