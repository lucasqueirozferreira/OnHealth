...
<body>
  <header class="cd-main-header js-cd-main-header">
    <div class="cd-logo-wrapper">
      <a href="#0" class="cd-logo"><img src="https://imgur.com/3dYvHRT.png" alt="Logo"></a>
    </div>
  ...
  <main class="cd-main-content">
    ...
    <div class="cd-content-wrapper">
      <div class="text-component text-center">
      	<h1>Notícias</h1>
      	<iframe style="border: 0;" src="https://www.tecmundo.com.br/medicina/novidades" width="1000px" height="500px" frameborder="0" scrolling="yes" ></iframe>
      </div>
    </div> <!-- .content-wrapper -->
